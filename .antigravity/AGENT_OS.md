...
|------------------|-------------|
| `PENDING INPUT...` | **STOP. ASK USER:** *"System Ready. What are we building today?"* |
...
*Execute for EACH step in PLAN.md.*
...
*Execute after all PLAN.md steps are complete.*
...
# SKILL LIBRARY
*Executable sub-routines.*

## SKILL 1: SCAFFOLD
*Use when directory structure is missing.*
```bash
#!/bin/bash
...
*Output this after completing Phase 0.*
